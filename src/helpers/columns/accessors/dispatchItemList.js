...
export const dispatchItemMpnAccessor = () => "";
export const dispatchCustomerNameAccesor = row => (
...
export const dispatchItemCodeAccesor = row => row?.itemno;
export const dispatchItemDelivarySummaryAccesor = () => "";
